          ...
          {open && (
            <>
              ...
              <motion.div
                ...
                className="absolute right-0 mt-2 w-96 bg-white dark:bg-neutral-900 rounded-xl shadow-2xl border border-neutral-200 dark:border-neutral-800 z-50 overflow-hidden"
              >
                {/* Header */}
