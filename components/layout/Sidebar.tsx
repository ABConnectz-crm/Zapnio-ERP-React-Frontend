...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={clsx(
          'fixed top-0 left-0 z-30 h-screen w-64 bg-white border-r border-neutral-200 transition-transform duration-300 ease-in-out',
          'lg:translate-x-0',
      ...
      >
            ...
            {navigationItems.map((item) => (
              <div key={item.name}>
                <Link
                  href={item.href}
                  className={clsx(
                    'flex items-center justify-between gap-3 px-3 py-2.5 rounded-md transition-all duration-150 group',
                    isActive(item.href)
        ...
        <div className="p-4 border-t border-neutral-200">
          <div className="flex items-center gap-3 p-2 rounded-md hover:bg-neutral-50 cursor-pointer transition-colors">
